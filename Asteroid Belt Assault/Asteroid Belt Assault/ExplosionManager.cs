...
namespace Asteroid_Belt_Assault
{
    class ExplosionManager
    {
        ...
        private float explosionMaxSpeed = 6f;
        ...
        public ExplosionManager(Texture2D texture, Rectangle initialFrame, int pieceCount, Rectangle pointRectangle)
        {
            ...
            {
                pieceRectangles.Add(new Rectangle(initialFrame.X + (initialFrame.Width * i), initialFrame.Y, initialFrame.Width, initialFrame.Height));
            }
        ...
        public void AddExplosion(Vector2 location, Vector2 momentum)
        {
            ...
            {
                ExplosionParticles.Add(new Particle(pieceLocation, texture, pieceRectangles[rand.Next(0, pieceRectangles.Count)],
                    randomDirection(pieceSpeedScale) + momentum, Vector2.Zero, explosionMaxSpeed, durationCount, initialColor, finalColor));
            }
